...
{    
    ...
    {
        public static TDestination CopyTo<TDestination>(this object source, TDestination destination = null) where TDestination : class
        {
            var obj = destination ?? (TDestination)Activator.CreateInstance(typeof(TDestination));
        ...
        public static List<string> GetDaysDatesBetween(DateTime startDate, DateTime endDate)
        {
            List<string> allDates = new List<string>();
            for (DateTime date = startDate; date <= endDate; date = date.AddDays(1))
                allDates.Add(date.ToString("ddd"));
            return allDates;
